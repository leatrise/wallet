...
pub async fn add_asset(_permission: PermissionAdminWrite, asset_id: Json<AssetId>, stream_producer: &State<StreamProducer>) -> Result<ApiResponse<AssetId>, ApiError> {
