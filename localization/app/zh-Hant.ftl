...
settings_preferences_default_leverage = 預設槓桿
...
info_funding_payments_title = 資金費用
info_funding_payments_description = 資金費用是交易者之間的定期支付，用以使永續合約價格接近標的資產的現貨價格。正向資金費用表示多頭支付空頭，負向資金費用則表示空頭支付多頭。
info_funding_rate_title = 資金費率
info_funding_rate_description = 資金費率決定持有永續合約的成本，按小時計算，有助於維持永續合約與標的資產現貨價格之間的價格平衡。
info_liquidation_price_title = 強制平倉價格
info_liquidation_price_description = 強制平倉價格是當您的持倉價格達到此水平時，系統會自動平倉以防止進一步損失。當市場價格觸及此價格，您的持倉將被清算，並損失保證金。
info_open_interest_title = 未平倉合約量
info_open_interest_description = 未平倉合約量代表所有尚未結算的永續合約總價值，提供市場活動和流動性的參考。
